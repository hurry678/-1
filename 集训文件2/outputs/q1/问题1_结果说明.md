...
|---|---:|---:|---:|
| 基准追加调度 | 206.519 | 406.000 | 0 |
| 全局增量插入 | 193.169 | 401.600 | 0 |
| ALNS静态调度 | 171.394 | 332.800 | 0 |

## 附件9指标

| 指标 | 数值 |
|---|---:|
| AvgTransferTime/s | 171.39375 |
| AvgAssignTime/s | 0.0 |
| AvgPickupResponseTime/s | 67.33125 |
| AvgTransportTime/s | 88.0625 |
| AvgPausingTime/s | 1.38125 |
| Makespan/s | 332.8 |
| AvgEmptyDistance/mm | 18014.26875 |
| AvgTotalDistance/mm | 79285.559375 |
| SimulationRuntime/s | 0.928281 |
